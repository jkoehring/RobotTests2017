...
import org.usfirst.frc.team1165.robot.subsystems.PixyCam;
...
public class Robot extends IterativeRobot
{
	...
	public static final PixyCam pixyCam = new PixyCam(new SerialPort(38400, SerialPort.Port.kOnboard));
	public static OI oi;
	...
	/**
	 * Starts up USB cameras, initializing a server for each one.
	 */
